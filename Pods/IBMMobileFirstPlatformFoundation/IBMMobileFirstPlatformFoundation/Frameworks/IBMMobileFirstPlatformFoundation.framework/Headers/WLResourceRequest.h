 ...
 * }    
 *
 * @param url Relative URL of the microservice endpoint. For example : <code>cities</code>
 * @param method HTTP method to use.
 * @param backendServiceName Name of the backend service configured on server to fetch data from. For example :<code>resorts</code>
 * @param timeout The timeout in milliseconds for this request. For example : <code>3000</code>
 *
 * @example
