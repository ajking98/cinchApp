...
//        var userData:[String : Any] = ["name": user.name, "password": user.password, "email": user.email, "profilePic": user.profilePic, "private": user.privateOrPublic, "folders": [folder.folderName: ["icon": folder.iconImage, "numOfImg": folder.numOfImages, "numOfVids": folder.numOfVideos, "private": folder.privateOrPublic, "dateCreated": folder.dateCreated, "dateModified": folder.dateModified, "images": [ "url": folder.imgs ], "videos": folder.videos] ]]
//        // See Userdata in console
//        print(userData)
//        var user1 = userClass(name: "f", email: "f", password: "f", isPrivate: "f", profilePic: "f", folder: <#T##folderClass#>)
